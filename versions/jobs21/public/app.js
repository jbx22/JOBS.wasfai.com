...
const I18N = {
  ar: {
    ...
    addSources: "أضف المصادر",
    addSourcesText: "اختر APIs معتمدة، أو مواقع HTML عامة، أو إدخال يدوي.",
    ...
    gateText: "الدرجات مخفية من المسار الرئيسي حتى يتم تحسين السيرة الأصلية واعتمادها.",
    nextMatches: "أفضل الفرص",
    open: "فتح",
    matchesEmptyReady: "شغّل فحص مصدر لإضافة وظائف مطابقة.",
  ...
  en: {
    ...
    addSourcesText: "Choose approved APIs, public HTML boards, or manual paste/import.",
    ...
    gateText: "Scores are hidden from the main journey until the original resume is improved and approved.",
    nextMatches: "Next matches",
    open: "Open",
    matchesEmptyReady: "Run a source scan to bring in matched jobs.",
...
function renderCommandHome() {
  ...
  const actionCards = [
    ...
    [tr("addSources"), tr("addSourcesText"), "/settings", iconCog(), `${sources.length}`, sources.length > 0],
