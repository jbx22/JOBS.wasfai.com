...
- DeepSeek V4 Flash is the default AI provider. The UI also offers MiniMax M3, GLM 5.2, and Kimi K2.7 model choices.
- Supported environment keys:
  ...
  - GLM/Z.ai: `GLM_API_KEY` or `ZAI_API_KEY`/`ZHIPU_API_KEY`, optional model/base URL overrides.
  - Kimi/Moonshot: `KIMI_API_KEY` or `MOONSHOT_API_KEY`, optional model/base URL overrides.
